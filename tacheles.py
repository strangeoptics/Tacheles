...
class Tacheles:
    ...
    def _initialize_users() -> dict:
        ...
        return {
            ...
            "ADrossel": "49 Jahre alt, wohnt in Langen in seinem eigenen Haus das er seinen Eltern abgekauft hat. Er liest gerne das Magazin Geo, hat gerade seinen Anglerschein gemacht und hat einen Chatbot der BozzeBot heißt aber nichts wirklich kann.",
        }
